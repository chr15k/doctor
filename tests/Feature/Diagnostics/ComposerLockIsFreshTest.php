...
it('checks Composer lock freshness through Composer validate', function (): void {
    ...
    Process::assertRan(fn ($process): bool => $process->command === ['composer', 'validate', '--strict', '--no-check-publish']);
